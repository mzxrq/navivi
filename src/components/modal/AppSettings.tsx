...
import { X, Key, ExternalLink, Moon, Sun, Monitor, Map, Settings, Palette, Save } from "lucide-react";
...
export function AppSettings() {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in">
      <div className="w-[540px] bg-white dark:bg-navidark-900 border border-zinc-200 dark:border-navidark-400 rounded-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    How long should Navivi wait after your last edit before saving in the background?
                  </p>
                  <select 
                    value={autoSaveInterval}
                    onChange={(e) => updateSettings({ auto_save_interval: parseInt(e.target.value) })}
            ...
            {activeTab === "api" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Navivi uses OpenRouteService for driving and walking directions. Provide your own free API key to enable routing.
                  </p>
                  <input
                    type="password"
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-[11px] font-semibold text-navi-600 hover:text-navi-800 dark:text-navi-400 dark:hover:text-navi-300 transition-colors"
                  >
