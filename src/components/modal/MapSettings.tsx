...
export function MapSettings() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2.5 rounded-full transition-all drop-shadow-xl font-bold ${isOpen ? "bg-zinc-400 hover:bg-zinc-600 text-white shadow-zinc-200/25 border border-zinc-200" : "bg-white dark:bg-zinc-800 text-zinc-700  hover:bg-zinc-200 dark:text-zinc-200 dark:hover:bg-zinc-500"}`}
  ...
  return (
    <div className="absolute top-11 right-0 w-60 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-2xl shadow-2xl p-5 z-40 animate-in fade-in zoom-in-95">
